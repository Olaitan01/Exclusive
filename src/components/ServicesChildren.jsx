  ...
  return (
    <div className="flex justify-center desktop:justify-between tablet:justify-between tablet:w-full tablet:gap-2 items-center m-auto w-[70vw] my-20 flex-wrap gap-8  ">
      {services.map((service, index) => (
        ...
        >
          <div
            className={`serviceIcon h-14 w-14 bg-primaryBlk rounded-full flex justify-center items-center border-[.4em] border-solid border-gray-300 overflow-hidden hover:${iconBg} `}
          >
            {service.icon}
          </div>
