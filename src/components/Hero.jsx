...
import apple from "../assets/images/1200px-Apple_gray_logo 1.png";
      ...
      <div className=" flex items-center justify-between bg-black text-[#ffffff] p-4 desktop:px-8 mt-6">
        <div className="flex flex-col items-start gap-4">
          <div className="flex items-center gap-4 desktop:gap-8 ">
            ...
            <span className="text-xs desktop:text-sm font-light">
              iPhone 14 Series
            </span>
          </div>
          ...
          <button className="flex  items-center cursor-pointer">
            <span className="font-light text-xs desktop:text-sm border-b-[0.1px] border-solid border-[#ffffff]">
              Shop Now
            </span>
