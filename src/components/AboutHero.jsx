...
function AboutHero() {
  return (
    <div className="flex flex-col-reverse gap-8  desktop:flex-row  tablet:flex-row justify-between items-center my-4">
      <div>
        <h1 className="desktop:text-5xl text-xl font-semibold pb-4 desktop:pb-6">Our Story</h1>
        <p className="desktop:text-lg tablet:text-lg font-normal pb-4 desktop:w-[70.5%] tablet:w-[65%] text-justify leading-6">
